...
public class TorneoController {
    ...
    public ResponseEntity<TorneoResponse> censitaSquadraAlTorneo(@PathVariable String idTorneo, @PathVariable String idSquadra) throws SQLException {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminaTorneoConSquadreAndGiocatori(
            @ApiParam("Id torneo")@PathVariable String id) throws Exception {
